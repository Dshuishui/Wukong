...
func (c *kVClient) GetInRaft(ctx context.Context, in *GetInRaftRequest, opts ...grpc.CallOption) (*GetInRaftResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/KV/GetInRaft", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kVClient) ScanRangeInRaft(ctx context.Context, in *ScanRangeRequest, opts ...grpc.CallOption) (*ScanRangeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/KV/ScanRangeInRaft", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kVClient) PutInRaft(ctx context.Context, in *PutInRaftRequest, opts ...grpc.CallOption) (*PutInRaftResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/KV/PutInRaft", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
